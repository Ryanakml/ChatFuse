...
const rotationCallbacks: SecretRotatedCallback[] = [];
 ...
 */
export function onSecretRotated(callback: SecretRotatedCallback): void {
 ...
 */
export function validateSecrets(env: Record<string, string | undefined>): SecretRotationResult {
  const valid: SecretName[] = [];
 ...
 */
export function clearRotationCallbacks(): void {
