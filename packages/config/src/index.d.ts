...
export declare const OPTIONAL_ENV_VARS: readonly ["LANGCHAIN_TRACING_V2", "LANGCHAIN_API_KEY", "ALLOW_INSECURE_HTTP", "TRUST_PROXY", "ADMIN_IP_ALLOWLIST", "ADMIN_RATE_LIMIT_WINDOW_MS", "ADMIN_RATE_LIMIT_MAX", "ADMIN_AUTH_HEADER", "ADMIN_ROLE_HEADER", "ADMIN_ALLOWED_ROLES", "WEBHOOK_IDEMPOTENCY_TTL_SECONDS", "WORKER_CONCURRENCY", "WORKER_JOB_TIMEOUT_MS"];
