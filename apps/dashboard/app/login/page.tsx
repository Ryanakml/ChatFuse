...
export default function LoginPage({
  ...
  return (
    <div
      ...
      style={{ fontFamily: 'Inter, var(--font-geist-sans), Arial, sans-serif' }}
    >
      {/* Logo SVG dari landing page */}
      <style>{`
        @import url('https://fonts.googleapis.com/css2?family=Inter:wght@400;700&display=swap');
      `}</style>
      <div
        className="w-full max-w-md rounded-xl border bg-white p-8 text-black shadow-lg dark:bg-gray-900 dark:text-gray-100"
        style={{
          borderColor: '#144B4B',
          borderWidth: 2,
          boxShadow: '0 4px 24px 0 rgba(20,75,75,0.10)',
        }}
      >
        ...
        <h1
          ...
          style={{ color: '#144B4B', letterSpacing: 1 }}
        >
          WA Chat Login
        </h1>
